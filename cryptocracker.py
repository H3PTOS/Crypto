...
# Constants
LOG_FILE_NAME = "crackerlogs.log"
ENV_FILE_NAME = "Cracker.env"
...
def update_cmd_title():
    ...
    if platform.system() == "Windows":
        os.system(f"title Bruter - Wallets Scanned: 151512{wallets_scanned} / Profit: 600$")
